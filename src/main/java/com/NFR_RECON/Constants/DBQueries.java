...
public class DBQueries {
    ...
    public static final QueryBean GET_PRODUCT_SUBSCRIPTION_ID = new QueryBean("SELECT subscription_id FROM " + DbTables.TBL_COMMON_SUBSCRIPTION + " WHERE gstin_id = :gstinId AND product_name = :productName ORDER BY ID DESC LIMIT 1");
