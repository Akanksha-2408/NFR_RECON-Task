 ...
 */
@Entity
@Table(name = DbTables.TBL_COMM_SUB_PURCHASED_ADDONS)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@DynamicInsert()
@DynamicUpdate()
public class PurchasedCommonSubAddOnVO {
    ...
    @JoinColumn(name = "COMMON_SUB_ID")
    private CommonSubscriptionDetailsVO commonSubscriptionDetailsVO;
    ...
    public CommonSubscriptionDetailsVO getCommonSubscriptionDetailsVO() {
        return commonSubscriptionDetailsVO;
    }

    public void setCommonSubscriptionDetailsVO(CommonSubscriptionDetailsVO commonSubscriptionDetailsVO) {
        this.commonSubscriptionDetailsVO = commonSubscriptionDetailsVO;
    }
